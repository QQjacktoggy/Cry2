...
try:
    ...
    from backtest_tool.strategies.regime_composite_vbt import RegimeCompositeVBTStrategy
    ...
    STRATEGY_MAP: dict = {
        # Regime composite (new)
        "regime_composite": RegimeCompositeVBTStrategy,
        # Baseline 4
        ...
        # G5: Pair trading (1)
        "pair_btc_eth": PairTradingBTCETH,
        # H: Phase 7 (10)
